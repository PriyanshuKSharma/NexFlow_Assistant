...
cors_origins = [
    ...
    for origin in os.getenv(
        "CORS_ORIGINS",
        "http://localhost:5173,http://127.0.0.1:5173,https://nexflowassisstant.vercel.app,https://nexflowassisstant-git-main-priyanshu-kumar-sharmas-projects.vercel.app"
    ).split(",")
    if origin.strip()
]
